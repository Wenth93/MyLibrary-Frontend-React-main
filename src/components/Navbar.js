...
function Navbar() {
    ...
    const exit = () => {
        logout()
        setUserId(null)
        toast.error("Tu t'es déconnecté ! À Bientôt.")
    };
                            ...
                            <>
                                <li className='nav-item nav-links' >                          
                                    <Dropdown>
                                        ...
                                        <Dropdown.Toggle variant="none" className='nav-links nav-link' >
                                    ...
                                    <Dropdown>
                                        <Dropdown.Toggle variant="none" className='nav-links nav-link'>
                                            <button className='btn btn-success' style={{marginRight:"20px"}}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-shield-fill-check m-0" viewBox="0 0 16 16">
                                        ...
                                        <Dropdown.Menu>
                                            ...
                                            <Dropdown.Divider />
                                            <Dropdown.Item>
                                                <Link className='btn btn-block w-100 btn-danger text-white' to="myprofile" onClick={exit}>
